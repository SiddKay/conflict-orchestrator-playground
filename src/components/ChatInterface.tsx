...
export const ChatInterface = ({ simulationStarted, selectedNodeId }: ChatInterfaceProps) => {
  ...
  const handleNext = () => {
    ...
    const nextMessage: Message = {
      ...
      msg: currentAgent === 'Bob' 
        ? "Italian again? We always go Italian. Can't we try something different for once?"
        : "I suggested it because I know you love pasta. I was trying to be thoughtful.",
  ...
  const handleUserMessage = () => {
    ...
    const userMessage: Message = {
      id: Date.now().toString(),
      msg: userInput,
      mood: 'neutral', // This should come from API analysis
      agent: currentAgent,
      timestamp: new Date()
    };
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="p-4 border-t border-slate-700/50 space-y-3">
        ...
        <div className="flex gap-2">
          <Button 
            onClick={handleNext}
            className="flex-1 bg-gradient-to-r from-purple-600/80 to-blue-600/80 hover:from-purple-600 hover:to-blue-600"
          >
